...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateInputs() {
        ...
        if (!emailInput.value.trim()) {
            emailError.textContent = 'Admin Email/Username is required';
    ...
    // Login function - Only allows Admin role (not Super Admin)
    async function handleLogin() {
        ...
        try {
            ...
            // Validate role - Only Admin can login here (not Super Admin or Client User)
            if (userRole === 'Super Admin') {
                await auth.signOut();
                throw new Error('Access denied. Super Admin accounts must use the Super Admin login portal.');
            } else if (userRole === 'Client User') {
                await auth.signOut();
                throw new Error('Access denied. This portal is for administrators only. Please use the student login page.');
            ...
            await logAuditTrail(userCredential.user.uid, 'login', 'Admin logged in successfully');
    ...
    function getErrorMessage(error) {
        ...
        if (errorCode === 'auth/user-not-found' || errorCode === 'auth/wrong-password') {
            return 'Invalid admin email/username or password';
